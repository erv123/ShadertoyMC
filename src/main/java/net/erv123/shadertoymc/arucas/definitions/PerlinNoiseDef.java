...
public class PerlinNoiseDef extends CreatableDefinition<Perlin> {
	...
	@ConstructorDoc(
		...
		examples = "noise = new PerlinNoise();"
	)
	...
	@ConstructorDoc(
		...
		examples = "noise = new PerlinNoise(1);"
	)
	...
	@ConstructorDoc(
		...
		examples = "noise = new PerlinNoise(1, 0.1);"
	)
	...
	@ConstructorDoc(
		...
		examples = "noise = new PerlinNoise(1, 0.1, 2);"
	)
	...
	@ConstructorDoc(
		...
		examples = "noise = new PerlinNoise(1, 0.1, 2, 2);"
	)
	...
	@ConstructorDoc(
		...
		examples = "noise = new PerlinNoise(1, 0.1, 2, 2, 2);"
	)
	...
	@ConstructorDoc(
		...
		examples = "noise = new PerlinNoise(1, 0.1, 2, 2, 2, \"best\");"
	)
	...
	@FunctionDoc(
		...
		examples = "noise.getNoiseQuality();"
	)
